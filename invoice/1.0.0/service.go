...
const (
	InvoiceTypeTypeINVOICE InvoiceTypeType = "INVOICE"

	InvoiceTypeTypeCREDITMEMO InvoiceTypeType = "CREDIT MEMO"
)
...
type QueryTypeType string

const (
	QueryTypeType1 QueryTypeType = "1"

	QueryTypeType2 QueryTypeType = "2"

	QueryTypeType3 QueryTypeType = "3"

	QueryTypeType4 QueryTypeType = "4"
)
...
type AccountInfo struct {
	...
	Address2 *AddressLine `xml:"Address2,omitempty" json:"Address2,omitempty"`
...
type ServiceMessage struct {
	XMLName xml.Name `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ ServiceMessage"`
...
type GetInvoicesRequest struct {
	...
	WsVersion *string `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ wsVersion,omitempty" json:"wsVersion,omitempty"`

	Id *string `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ id,omitempty" json:"id,omitempty"`

	Password *string `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ password,omitempty" json:"password,omitempty"`

	QueryType *int `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ queryType,omitempty" json:"queryType,omitempty"`

	ReferenceNumber *string `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ referenceNumber,omitempty" json:"referenceNumber,omitempty"`

	RequestedDate *RequestedDate `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ requestedDate,omitempty" json:"requestedDate,omitempty"`

	AvailableTimeStamp *AvailableTimeStamp `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/SharedObjects/ availableTimeStamp,omitempty" json:"availableTimeStamp,omitempty"`
}
...
type Invoice struct {
	...
	} `xml:"BillTo,omitempty" json:"BillTo,omitempty"`
...
type GetInvoicesResponse struct {
	XMLName xml.Name `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/ GetInvoicesResponse"`

	InvoiceArray struct {
		Invoice []*Invoice `xml:"Invoice,omitempty" json:"Invoice,omitempty"`
	} `xml:"InvoiceArray,omitempty" json:"InvoiceArray,omitempty"`
...
type GetVoidedInvoicesResponse struct {
	XMLName xml.Name `xml:"http://www.promostandards.org/WSDL/Invoice/1.0.0/ GetVoidedInvoicesResponse"`

	VoidedInvoiceArray struct {
		VoidedInvoice []*VoidedInvoice `xml:"VoidedInvoice,omitempty" json:"VoidedInvoice,omitempty"`
	} `xml:"VoidedInvoiceArray,omitempty" json:"VoidedInvoiceArray,omitempty"`

	ServiceMessageArray *ServiceMessageArray `xml:"ServiceMessageArray,omitempty" json:"ServiceMessageArray,omitempty"`
}

type InvoiceService interface {
	GetInvoices(request *GetInvoicesRequest) (*GetInvoicesResponse, error)

	GetInvoicesContext(ctx context.Context, request *GetInvoicesRequest) (*GetInvoicesResponse, error)

	GetVoidedInvoices(request *GetVoidedInvoicesRequest) (*GetVoidedInvoicesResponse, error)

	GetVoidedInvoicesContext(ctx context.Context, request *GetVoidedInvoicesRequest) (*GetVoidedInvoicesResponse, error)
}
...
func NewInvoiceService(client *soap.Client) InvoiceService {
	return &invoiceService{
		client: client,
	}
}

func (service *invoiceService) GetInvoicesContext(ctx context.Context, request *GetInvoicesRequest) (*GetInvoicesResponse, error) {
	response := new(GetInvoicesResponse)
	err := service.client.CallContext(ctx, "getInvoices", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *invoiceService) GetInvoices(request *GetInvoicesRequest) (*GetInvoicesResponse, error) {
...
func (service *invoiceService) GetVoidedInvoicesContext(ctx context.Context, request *GetVoidedInvoicesRequest) (*GetVoidedInvoicesResponse, error) {
	response := new(GetVoidedInvoicesResponse)
	err := service.client.CallContext(ctx, "getVoidedInvoices", request, response)
	if err != nil {
		return nil, err
	}
...
func (service *invoiceService) GetVoidedInvoices(request *GetVoidedInvoicesRequest) (*GetVoidedInvoicesResponse, error) {
	return service.GetVoidedInvoicesContext(
		context.Background(),
		request,
	)
}
